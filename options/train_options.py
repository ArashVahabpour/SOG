...
class TrainOptions(BaseOptions):
    def __init__(self):
        ...
        #TODO add tflog
        self.parser.add_argument('--display_freq', type=int, default=256, help='frequency of showing training results on screen')
        self.parser.add_argument('--print_freq', type=int, default=5, help='frequency of showing training results on console')
        self.parser.add_argument('--save_latest_freq', type=int, default=1024, help='frequency of saving the latest results')
